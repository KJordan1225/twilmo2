            ...
            >
                ...
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                        ...
                        <div className="p-6">
                            Peer-to-Peer (P2P) payment systems have become a huge part of our lives in
                            the past decade. For example, PayPal, Venmo, and Cash App have become a part
                            of internet lingo, just like Google. P2P is so important that social media
                            and communication apps, such as Snapchat, WeChat, and Facebook, have
                            incorporated these features in recent years.<br></br><br></br>
                            Welcome to the Demo Peer-to-Peer payment system that is a very simplistic
                            "reproduction" of the Venmo app.  This web application integrates Laravel with the Stripe
                            payment processing system.  It also leverages React, Inertia, and Tailwind CSS.
                            <br></br><br></br>
                            Click HERE to view/download instructions on how to use the application.
